    ...
    if event.reply_to_msg_id is not None:
        ...
        if input_str == "e":
            ...
            if len(lsts) > 0:
                ...
                output_str = "no Lydia AI enabled users / chats. Start by replying `.eai` to any user in any chat! or .dai to stop replying to any user in any chat! or .lai for List Of Currently added Users in any chat!"
